...
public:
  ...
  bool Intersect3d(const ELEMTYPE s_start[3], const ELEMTYPE s_end[3], std::function<bool(const DATATYPE &, const ELEMTYPE[3], const ELEMTYPE[3], ELEMTYPE &)> callback,ELEMTYPE& outDist) const;
...
protected:
  ...
  bool Intersect3d(Node *a_node, Seg3d *a_rect, bool &IntersectFlag, std::function<bool(const DATATYPE &, const ELEMTYPE a_min[3], const ELEMTYPE a_max[3], ELEMTYPE &)> callback,ELEMTYPE& outDist) const;
...
bool RTREE_QUAL::Load(RTFileStream &a_stream)
{
  ...
  // std::cout<<"_dataFileId: "<<_dataFileId<<std::endl;
  // std::cout<<"_dataSize: "<<_dataSize<<std::endl;
  // std::cout<<"_dataNumDims: "<<_dataNumDims<<std::endl;
  // std::cout<<"_dataElemSize: "<<_dataElemSize<<std::endl;
  // std::cout<<"_dataElemRealSize: "<<_dataElemRealSize<<std::endl;
  // std::cout<<"_dataMaxNodes: "<<_dataMaxNodes<<std::endl;
  // std::cout<<"_dataMinNodes: "<<_dataMinNodes<<std::endl;
  ...
  // std::cout<<"dataFileId: "<<dataFileId<<std::endl;
  // std::cout<<"dataSize: "<<dataSize<<std::endl;
  // std::cout<<"dataNumDims: "<<dataNumDims<<std::endl;
  // std::cout<<"dataElemSize: "<<dataElemSize<<std::endl;
  // std::cout<<"dataElemRealSize: "<<dataElemRealSize<<std::endl;
  // std::cout<<"dataMaxNodes: "<<dataMaxNodes<<std::endl;
  // std::cout<<"dataMinNodes: "<<dataMinNodes<<std::endl;
